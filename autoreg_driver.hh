...
/// calls all subroutines, and prints the result.
    ...
    struct Autoreg_model {
        ...
        void act() {
            FormattedTimer timer("timer_log_1", zsize, acf_size);
            ...
            timer.end_clock();
            timer.write("generate_white_noize");
            ...
            timer.end_clock();
            timer.write("trim_zeta\t");

            timer.begin_clock();
            write_zeta(zeta);
            timer.end_clock();
            timer.write("write_zeta\t");
        }
